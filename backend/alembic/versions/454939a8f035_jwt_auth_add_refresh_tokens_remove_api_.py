...
def downgrade() -> None:
    ...
    op.add_column(
        "families", sa.Column("api_token_hash", sa.String(64), nullable=False, server_default="")
    )
    op.add_column(
        "families",
        sa.Column("token_created_at", sa.DateTime(), nullable=False, server_default=sa.func.now()),
    )
